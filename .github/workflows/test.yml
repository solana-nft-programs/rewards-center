  ...
  integration-tests:
    ...
    steps:
      ...
      - name: Run local validator
        run: solana-test-validator --url https://api.mainnet-beta.solana.com --clone metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s --clone PwDiXFxQsGra4sFFTT8r1QWRMd4vfumiWC1jfWNfdYT --clone 3dxFgrZt9DLn1J5ZB1bDwjeDvbESzNxA11KggRcywKbm --clone AmJdpbtEzFBVWhznaEQM3V4fNZBa8FWj36Lu2BtnaDYt --bpf-program rwcn6Ry17ChPXpJCN2hoK5kwpgFarQqzycXwVJ3om7U ./target/deploy/cardinal_rewards_center.so --reset --quiet & echo $$! > validator.PID
      - run: sleep 6
